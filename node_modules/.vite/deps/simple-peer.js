...
import { t as __commonJSMin } from "./chunk-DZJw5X4F.js";
...
//#endregion
//#region node_modules/get-browser-rtc/index.js
var require_get_browser_rtc = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/randombytes/browser.js
...
//#endregion
//#region node_modules/err-code/index.js
...
//#endregion
//#region node_modules/simple-peer/index.js
var require_simple_peer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*! simple-peer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */
	var debug = require_browser$2()("simple-peer");
	var getBrowserRTC = require_get_browser_rtc();
	var randombytes = require_browser$1();
	...
	* @param {Object} opts
	*/
	var Peer = class Peer extends stream.Duplex {
		constructor(opts) {
			...
			if (!this._wrtc) if (typeof window === "undefined") throw errCode(/* @__PURE__ */ new Error("No WebRTC support: Specify `opts.wrtc` option in this environment"), "ERR_WEBRTC_SUPPORT");
			else throw errCode(/* @__PURE__ */ new Error("No WebRTC support: Not a supported browser"), "ERR_WEBRTC_SUPPORT");
			this._pcReady = false;
			...
			if (this.initiator || this.channelNegotiated) this._setupData({ channel: this._pc.createDataChannel(this.channelName, this.channelConfig) });
		...
		signal(data) {
			...
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot signal after peer is destroyed"), "ERR_DESTROYED");
			...
			if (data.candidate) if (this._pc.remoteDescription && this._pc.remoteDescription.type) this._addIceCandidate(data.candidate);
			...
			if (!data.sdp && !data.candidate && !data.renegotiate && !data.transceiverRequest) this.destroy(errCode(/* @__PURE__ */ new Error("signal() called with invalid signal data"), "ERR_SIGNALING"));
		}
		...
		*/
		send(chunk) {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot send after peer is destroyed"), "ERR_DESTROYED");
		...
		*/
		addTransceiver(kind, init) {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot addTransceiver after peer is destroyed"), "ERR_DESTROYED");
		...
		*/
		addStream(stream) {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot addStream after peer is destroyed"), "ERR_DESTROYED");
		...
		*/
		addTrack(track, stream) {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot addTrack after peer is destroyed"), "ERR_DESTROYED");
			...
			if (!sender) {
				...
				this._needsNegotiation();
			} else if (sender.removed) throw errCode(/* @__PURE__ */ new Error("Track has been removed. You should enable/disable tracks that you want to re-add."), "ERR_SENDER_REMOVED");
			else throw errCode(/* @__PURE__ */ new Error("Track has already been added to that stream."), "ERR_SENDER_ALREADY_ADDED");
		}
		/**
		...
		*/
		replaceTrack(oldTrack, newTrack, stream) {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot replaceTrack after peer is destroyed"), "ERR_DESTROYED");
			this._debug("replaceTrack()");
			const submap = this._senderMap.get(oldTrack);
			const sender = submap ? submap.get(stream) : null;
			if (!sender) throw errCode(/* @__PURE__ */ new Error("Cannot replace track that was never added."), "ERR_TRACK_NOT_ADDED");
			if (newTrack) this._senderMap.set(newTrack, submap);
			if (sender.replaceTrack != null) sender.replaceTrack(newTrack);
			else this.destroy(errCode(/* @__PURE__ */ new Error("replaceTrack is not supported in this browser"), "ERR_UNSUPPORTED_REPLACETRACK"));
		}
		/**
		...
		*/
		removeTrack(track, stream) {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot removeTrack after peer is destroyed"), "ERR_DESTROYED");
			this._debug("removeSender()");
			const submap = this._senderMap.get(track);
			const sender = submap ? submap.get(stream) : null;
			if (!sender) throw errCode(/* @__PURE__ */ new Error("Cannot remove track that was never added."), "ERR_TRACK_NOT_ADDED");
			try {
				sender.removed = true;
				this._pc.removeTrack(sender);
			} catch (err) {
				if (err.name === "NS_ERROR_UNEXPECTED") this._sendersAwaitingStable.push(sender);
		...
		*/
		removeStream(stream) {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot removeStream after peer is destroyed"), "ERR_DESTROYED");
		...
		negotiate() {
			if (this.destroying) return;
			if (this.destroyed) throw errCode(/* @__PURE__ */ new Error("cannot negotiate after peer is destroyed"), "ERR_DESTROYED");
			if (this.initiator) if (this._isNegotiating) {
		...
		_setupData(event) {
			if (!event.channel) return this.destroy(errCode(/* @__PURE__ */ new Error("Data channel event is missing `channel` property"), "ERR_DATA_CHANNEL"));
			...
			this._channel.onerror = (event) => {
				const err = event.error instanceof Error ? event.error : /* @__PURE__ */ new Error(`Datachannel error: ${event.message} ${event.filename}:${event.lineno}:${event.colno}`);
		...
		_write(chunk, encoding, cb) {
			if (this.destroyed) return cb(errCode(/* @__PURE__ */ new Error("cannot write after peer is destroyed"), "ERR_DATA_CHANNEL"));
			if (this._connected) {
				try {
					this.send(chunk);
				} catch (err) {
		...
		_onConnectionStateChange() {
			if (this.destroyed) return;
			if (this._pc.connectionState === "failed") this.destroy(errCode(/* @__PURE__ */ new Error("Connection failed."), "ERR_CONNECTION_FAILURE"));
		}
		_onIceStateChange() {
			if (this.destroyed) return;
			...
			if (iceConnectionState === "failed") this.destroy(errCode(/* @__PURE__ */ new Error("Ice connection failed."), "ERR_ICE_CONNECTION_FAILURE"));
			if (iceConnectionState === "closed") this.destroy(errCode(/* @__PURE__ */ new Error("Ice connection closed."), "ERR_ICE_CONNECTION_CLOSED"));
		}
		getStats(cb) {
